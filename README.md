![docker image](https://github.com/niklassiemer/cmnomad/actions/workflows/docker-publish.yml/badge.svg)


# niklassiemer's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of niklassiemer.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/niklassiemer/cmnomad.git
    cd cmnomad
    ```
    ...
    ```sh
    curl-L -o cmnomad.zip "https://github.com/niklassiemer/cmnomad/archive/main.zip"
    unzip cmnomad.zip
    cd cmnomad
    ```
...
your `docker-compose.yaml` with `ghcr.io/niklassiemer/cmnomad:main` for the services
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/niklassiemer/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/niklassiemer/cmnomad/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/niklassiemer/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/niklassiemer/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/niklassiemer/cmnomad/manifests/main": unauthorized`
